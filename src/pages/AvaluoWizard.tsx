...
import { ExpedienteAdminPanel } from '@/components/expedientes/ExpedienteAdminPanel';
import {
  ChevronLeft,
  ChevronRight,
  Eye,
...
export default function AvaluoWizard() {
  ...
  const steps: Step[] = [
    {
      id: 1,
      title: 'Perito firmante',
      subtitle: 'Define plantilla INMOVAL',
    },
    {
      id: 2,
      title: 'Cliente / Solicitante',
      subtitle: 'Datos del solicitante',
    },
    {
      id: 3,
      title: 'Cap. I — Información general',
      subtitle: 'Expediente y propósito',
    },
    {
      id: 4,
      title: 'Cap. II — Documentación legal',
      subtitle: 'Escritura · Registro · Catastro',
    },
    {
      id: 5,
      title: 'Cap. III — Entorno urbano',
      subtitle: 'Zona · Servicios · Vías',
    },
    {
      id: 6,
      title: 'Cap. IV — Terreno(s)',
      subtitle: `${avaluo.terrenos.length} terreno(s) · linderos`,
    },
    {
      id: 7,
      title: 'Cap. V — Infraestructuras',
      subtitle: 'Memoria de costos · Ross-Heidecke',
    },
    {
      id: 8,
      title: 'Cap. VI — Metodología',
      subtitle: 'Costo · Mercado · Realización',
    },
    {
      id: 9,
      title: 'Cap. VII — Anexo fotográfico',
      subtitle: 'Registro visual',
    },
    {
      id: 10,
      title: 'Formato del PDF',
      subtitle: 'Portada · encabezado · pie · tipografía',
    },
    {
      id: 11,
      title: 'Vista previa',
  ...
  const render = () => {
    switch (current) {
      case 0:
        return <StepPerito avaluo={avaluo} />;
      case 1:
        return <StepCliente avaluo={avaluo} />;
      case 2:
        return <StepInfo avaluo={avaluo} />;
      case 3:
        return <StepLegal avaluo={avaluo} />;
      case 4:
        return <StepEntorno avaluo={avaluo} />;
      case 5:
        return <StepTerrenos avaluo={avaluo} />;
      case 6:
        return <StepInfraestructuras avaluo={avaluo} />;
      case 7:
        return <StepMetodologias avaluo={avaluo} />;
      case 8:
        return <StepFotos avaluo={avaluo} />;
      case 9:
        return <StepFormato avaluo={avaluo} />;
      case 10:
        return <StepPreview avaluo={avaluo} />;
      default:
        return <StepInfo avaluo={avaluo} />;
    }
  };
  ...
  const guardar = () => {
    updateAvaluo(avaluo.id, {
      estado:
        avaluo.estatusOperativo === 'borrador'
          ? 'borrador'
          : avaluo.estatusOperativo === 'entregado' ||
              avaluo.estatusOperativo === 'cerrado'
            ? 'finalizado'
            : 'en_proceso',
    });
    ...
    <div className="flex min-h-[calc(100vh-3rem)]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="border-b border-border bg-card/40 px-6 py-3 flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="font-semibold">
              {avaluo.info.numeroExpediente || 'Nuevo expediente urbano'}
            </h1>
          </div>
        ...
        <div className="flex-1 p-6 overflow-auto space-y-6">
          <ExpedienteAdminPanel avaluo={avaluo} />
          {render()}
        </div>
        ...
        <footer className="border-t border-border bg-card/50 p-4 flex items-center justify-between">
          ...
          <div className="text-xs text-muted-foreground">
            Paso {current + 1} de {steps.length} · Guardado automático en el expediente
          </div>
