                    ...
                    >
                      ...
                      <td className="px-5 py-4 text-right">
                        <div className="group relative inline-flex justify-end">
                          ...
                          <div className="invisible absolute right-0 top-11 z-30 w-64 rounded-2xl border border-slate-800 bg-slate-950 p-2 text-left opacity-0 shadow-2xl shadow-black/50 transition group-hover:visible group-hover:opacity-100">
                            <button
                              type="button"
                              onClick={() => navigate(`/expedientes-plataforma/\${expediente.id}`)}
                            ...
                            <button
                              type="button"
                              onClick={() => navigate(`/expedientes-plataforma/\${expediente.id}?modo=editar`)}
                              className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-slate-200 hover:bg-slate-800"
                            >
                            ...
                            <button
                              type="button"
                              onClick={() => handleCambiarEstado(expediente)}
                              className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-slate-200 hover:bg-slate-800"
                            >
                            ...
                            <button
                              type="button"
                              onClick={() => handleCambiarPrioridad(expediente)}
                              className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-slate-200 hover:bg-slate-800"
                            >
                            ...
                            <button
                              type="button"
                              onClick={() => handleExportarImv(expediente)}
                              className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-slate-200 hover:bg-slate-800"
                            >
                            ...
                            <button
                              type="button"
                              onClick={() => handleExportarPlantilla(expediente)}
                            ...
                            <button
                              type="button"
                              onClick={() => handleEliminar(expediente)}
