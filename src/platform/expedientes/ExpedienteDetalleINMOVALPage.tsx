    ...
    <div className="min-h-screen bg-slate-950 px-6 py-8 text-slate-100">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-6 rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-xl shadow-black/20">
          ...
          <section className="mt-6 rounded-3xl border border-sky-400/20 bg-sky-400/10 p-5 shadow-xl shadow-black/20">
            <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
              ...
              <Link
                to={`/expedientes-plataforma/${expediente.id}/preparar-tecnico`}
